...
FOLDER_NAME = f'svm_use_pca_selected_features_{LEAVE_ON_OUT[0]}_{LEAVE_ON_OUT[1]}'
...
def hyper_tuning_svm_pca_only_reviewed_cases():
    ...
    with warnings.catch_warnings():
        ...
        for C in [0.01, 0.1, 1, 10]:
            ...
            RESULTS_DIR = join(ROOT_DIR, 'results', FOLDER_NAME,
                               f'{FOLDER_NAME}_{VARIANCE_PERCENT_PCA * 100}%_{hyper_info}')
            ...
            for info in tqdm(all_hospitals_and_years):
                ...
                if hospital_name == LEAVE_ON_OUT[0] and discharge_year == LEAVE_ON_OUT[1]:
                    ...
                    filename_output = join(RESULTS_DIR_TEST_PREDICTIONS,
                                           f'{FOLDER_NAME}_{VARIANCE_PERCENT_PCA * 100}%_varaince_{hyper_info}.csv')
...
if __name__ == '__main__':
    hyper_tuning_svm_pca_only_reviewed_cases()
    sys.exit(0)
