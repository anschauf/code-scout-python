...
RESULTS_DIR = join(ROOT_DIR, 'results', f'random_forest_only_reviewed_{LEAVE_ON_OUT[0]}_{LEAVE_ON_OUT[1]}', f'n_trees_{RANDOM_FOREST_NUM_TREES}-max_depth_{RANDOM_FOREST_MAX_DEPTH}-min_samples_leaf_{RANDOM_FOREST_MIN_SAMPLES_LEAF}')
