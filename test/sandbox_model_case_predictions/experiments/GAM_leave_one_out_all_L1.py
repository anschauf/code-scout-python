...
if USE_HAND_SELECTED_FEATURES:
    FOLDER_NAME = f'GAM_all_features_L1_{LEAVE_ON_OUT[0]}_{LEAVE_ON_OUT[1]}'
...
def LogisticGAM_L1_only_reviewed_cases():
    ...
    with warnings.catch_warnings():
        ...
        logger.info(f'Training a LogisticGAM L1:  ...')

        # Run LogisticGAM with default settings

        LogGAM_L1 = LogitGam.fit_regularized()
...
if __name__ == '__main__':
    LogisticGAM_L1_only_reviewed_cases()
    sys.exit(0)
