...
def train_random_forest_only_reviewed_cases():
    for RANDOM_FOREST_NUM_TREES in [1, 2, 5, 10]:
        for RANDOM_FOREST_MAX_DEPTH in [1, 5, 10, 25, 50]:
            RANDOM_FOREST_MIN_SAMPLES_LEAF = 1

            LEAVE_ON_OUT = ('KSW', 2020)
            RESULTS_DIR = join(ROOT_DIR, 'results',
                               f'random_forest_parameter_screen_without_mdc_run_02_{LEAVE_ON_OUT[0]}_{LEAVE_ON_OUT[1]}',
