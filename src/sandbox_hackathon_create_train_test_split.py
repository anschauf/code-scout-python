...
with Database() as db:
    ...
    full_data_train[['aimedic_id', 'y_label_is_revised_case']].to_csv(os.path.join('aimedic_id_label_data_train.csv'), index=False)
    full_data_test[['aimedic_id', 'y_label_is_revised_case']].to_csv(os.path.join('aimedic_id_label_data_test.csv'), index=False)
    ...
    full_data_test_revised_cases[[
        ...
        'PCCL_old',
        'PCCL_new'
    ]].to_csv(os.path.join('aimedic_id_revised_cases_test.csv'), index=False)
