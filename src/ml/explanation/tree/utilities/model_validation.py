...
def validate_model_type(model):
    ...
    known_model_types = [
        # RandomForests
        'sklearn.ensemble.forest.RandomForestClassifier', 'sklearn.ensemble._forest.RandomForestClassifier',
        'sklearn.ensemble.forest.RandomForestRegressor', 'sklearn.ensemble._forest.RandomForestRegressor',
        # Ensemble of extremely randomized trees
        'sklearn.ensemble.forest.ExtraTreesClassifier', 'sklearn.ensemble._forest.ExtraTreesClassifier',
        'sklearn.ensemble.forest.ExtraTreesRegressor', 'sklearn.ensemble._forest.ExtraTreesRegressor',

        # Decision trees
        'sklearn.tree.tree.DecisionTreeClassifier', 'sklearn.tree._classes.DecisionTreeClassifier',
