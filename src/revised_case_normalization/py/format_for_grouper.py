...
def format_for_grouper(df_joined: pd.DataFrame) -> pd.DataFrame:
    ...
    # Retrieving validated primary codes with sideness and date
    ...
    primary_procedures_revised = get_primary_procedures_codes_side_date(original_cases_primary_procedures,
                                                                        primary_procedures_revised)

    revised_cases['primary_procedure_grouper'] = primary_procedures_revised.primary_procedure_grouper_bfs.apply(
        lambda case: case + "::" if len(case) <= 6 else case)

    # Retrieving validated Secondary Procedures with sideness and date
    ...
    secondary_procedures_revised = get_secondary_procedures_codes_side_date(original_cases_secondary_procedures,
    ...
    # Retrieving primary and secondary diagnoses
