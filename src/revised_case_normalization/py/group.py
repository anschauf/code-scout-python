...
def group(revised_cases: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    """This function generates dataframes of the results generated by the grouper which will be read
        into the DB. Information is given on how many cases got grouped in a logger info message.

       @return: Three dataframes with updates on revisions, diagnoses and procedures for the DB.
       """
