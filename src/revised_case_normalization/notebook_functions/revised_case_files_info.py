...
REVISED_CASE_FILES = [
    ...
    #
    # FileInfo(os.path.join(DIR_INPUT_FILE, 'raw_data/Linth_Toggenburg_SRRWS_2019.xlsx'),
    ...
    #
    # FileInfo(os.path.join(DIR_INPUT_FILE, 'raw_data/KSSG_2021.xlsx'),
    #          'KSSG St. Gallen', '2021', 'Änderungen_KSSG_2021'),
    #
    # FileInfo(os.path.join(DIR_INPUT_FILE, 'raw_data/Linth_Toggenburg_SRRWS_2019.xlsx'),
    #          'KSSG Spitalregion Fürstenland Toggenburg', '2019', 'Änderungen_Toggenburg_2019'),
    #
    # FileInfo(os.path.join(DIR_INPUT_FILE, 'raw_data/USZ_2018-2019_20200730.xlsx'),
    ...
    #
    # FileInfo(
    #     os.path.join(DIR_INPUT_FILE, 'raw_data/Winterthur.xlsx'),
